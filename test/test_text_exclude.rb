...
require 'ostruct'
# TestTextExclude implements the basic unit tests. Comprehensive units tests are required actual validation. 
# However specifying exactly how all these functions are to work is not plausible when designing for
# a Command Line and Log interface.  
